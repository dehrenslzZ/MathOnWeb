...
<div class="multiview-container">
	...
	{:else}
		<div
			style="width: 49vw !important; height: 100vh !important; position: absolute; left: 0; top: 0"
		>
			<Navbar />
	...
	{#if $multiview && !isIframe}>
		<div
			style="width: 49vw !important; height: 100vh !important; position: absolute; right: 0; top: 0"
		>
			<iframe src={localUrl} {width} {height} />
		</div>
	{/if}
</div>
